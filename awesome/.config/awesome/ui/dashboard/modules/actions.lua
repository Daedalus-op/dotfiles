        ...
        {
            {
                id = "icon_role",
                markup = icon,
                font = font and font or beautiful.font_name .. " 22",
...
local bluetooth = mkactionicon("", beautiful.font_name .. " 19")
...
awesome.connect_signal("bluetooth::enabled", function(enabled)
    ...
    if enabled then
        bluetooth.font = beautiful.font_name .. " 16"
    else
        bluetooth.font = beautiful.font_name .. " 19"
    end
end)

local mic = mkactionicon("", beautiful.font_name .. " 16")
...
awesome.connect_signal("mic::active", function(enabled)
    ...
    if enabled then
        mic.font = beautiful.font_name .. " 16"
    else
        mic.font = beautiful.font_name .. " 18"
    end
end)
