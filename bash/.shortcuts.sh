...
alias e="vim" # Editor
alias mnte="sudo mount /dev/nvme0n1p5 /mnt/files" # Mount E drive
alias mntee="sudo mount /dev/nvme0n1p5 /mnt/files && exit" # Mount E drive and exit
alias umnte="sudo umount /mnt/files" # Unmount E drive
