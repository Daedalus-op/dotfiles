...
alias bluestart="sudo systemctl restart bluetooth.service" # Restart bluetooth
alias bluestop="sudo systemctl stop bluetooth.service"     # Restart bluetooth
...
## work
alias xilset="source /tools/Xilinx/Vivado/2024.2/settings64.sh"
